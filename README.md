...
RefClient - это Minecraft-лаунчер, который позволяет запускать любые версии игры, устанавливать моды и создавать модпаки. Поддерживает как пиратские, так и официальные аккаунты, а также имеет различные настройки оформления.

## Важные ссылки
- [Сайт лаунчера](https://refclient.ru)
- [Последний релиз лаунчера](https://github.com/Seeroy/RefClient2/releases/latest)
- [Плагин на сервер для поддержки системы скинов лаунчера](https://github.com/Seeroy/RefClient-Skins-Plugin)
...
RefClient разработан с использованием следующих технологий:
...
1. Клонируйте репозиторий:
    ```bash
    git clone https://github.com/Seeroy/RefClient2.git
    cd RefClient2
    ```
...
**RefClient** - отличный выбор для тех, кто хочет разнообразить и улучшить свой Minecraft-опыт!
