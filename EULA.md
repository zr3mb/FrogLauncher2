# Пользовательское соглашение RefClient
...
обеспечения RefClient, seeeroy (далее — «Разработчик»), и пользователем данного программного обеспечения
(далее — «Пользователь»). Используя RefClient, Пользователь соглашается с условиями данного Соглашения.

### 1. Общие положения
1.1. RefClient (далее — «Лаунчер») предназначен для запуска игры Minecraft с
...
Скачивая с официального сайта и используя продукт RefClient вы подтверждаете, что ознакомились с условиями данного Соглашения и согласны с ними.